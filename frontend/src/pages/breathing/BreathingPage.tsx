...
// import TickSound from '@/assets/audio/tick_1_second.mp3';
// import TickSound from '@/assets/audio/tick_900ms_click_at_start.mp3';
import TickSound from '@/assets/audio/tick_metronome.mp3';
import BellSound from '@/assets/audio/bell.mp3';
// import TickFastSound from '@/assets/audio/tick-fast.mp3';
import TickFastSound from '@/assets/audio/tick_metronome_fast.mp3';
                ...
                {isShowDescription && (
                    <div className='mt-4 flex justify-center text-center'>
                        <p className='w-3/4 text-sky-900 dark:text-sky-50'>
                            ...
                            Wim Hof, also known as "The Iceman," to increase
                            energy, reduce stress, and improve focus. It
                            involves cycles of deep inhalations and exhalations
                            followed by a breath hold. This method helps
                            activate the autonomic nervous system, enhances
                            mental clarity, and strengthens the immune system.
                        </p>
                    </div>
                )}
